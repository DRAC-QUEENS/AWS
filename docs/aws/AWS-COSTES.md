...
| EC2 WireGuard | t3.micro | 0,0104 $/h | 730 h | 7,59 $ |
| EC2 Nginx | t3.micro | 0,0104 $/h | 730 h | 7,59 $ |
| EC2 GLPI (ASG, desired=1) | t3.small | 0,0208 $/h | 730 h | 15,18 $ |
...
> **Nota:** el coste con `asg_desired = 2` (dos instancias GLPI simultáneas) añade ~15,18 $ adicionales (una EC2 t3.small más, con su EBS). El NAT Gateway es el componente más caro: representa el 33 % del total mensual aunque el tráfico sea mínimo, por su tarifa fija de horas.
...
| --- | --- | --- |
| Coste mensual estimado | ~69,29 $ | ~98,06 $ |
| Sobrecoste | — | +28,77 $ (+42 %) |
